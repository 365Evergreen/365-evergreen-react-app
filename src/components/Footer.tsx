    ...
    <footer className="footer-root">
      <div className="footer-main">
        <div className="footer-brand">
          ...
          <div>
            <div className="footer-title">365 Evergreen</div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-made">Made with <span className="footer-heart" role="img" aria-label="love">💚</span> for the planet</div>
      </div>
    </footer>
  );
}
